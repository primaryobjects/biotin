...
We can examine a linear regression model of the data by calculating the count by date. The result is a decrease of shedding by `r round(summary(fit)$coefficients['date',]['t value'], 2)` per 3-day period over the time of biotin supplementation.
